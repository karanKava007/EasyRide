...
import DriverFeedback from '../container/DriverFeedback';
  ...
  return (
    <Drawer.Navigator drawerContent={props => <CustomDrawer {...props} />}>
      <Drawer.Screen name="Dashbord1" component={Dashbord} options={{
        headerTransparent: true, title: 'Dashboard', headerTitle: '', drawerIcon: ({ focused, size }) => (
      ...
      <Drawer.Screen name="Feedback" component={Feedback} options={{
        headerTitle: 'Feedback', headerTitleAlign: 'center', headerTitleStyle: { fontFamily: 'Poppins-SemiBold', fontSize: 22, fontWeight: '600' }, drawerIcon: ({ focused, size }) => (
          <MaterialIcons name="feedback" size={size} color={focused ? '#2482e3' : '#898989'} />
        ),
      }
      }
      />
  ...
  return (
    <Drawer.Navigator drawerContent={props => <DriverCustomDrawer {...props} />}>
      <Drawer.Screen name="DriverDashboard1" component={DriverDashboard} options={{
        headerTransparent: false, title: 'Passenger Request', headerTitleAlign: 'center', headerTitleStyle: { fontFamily: 'Poppins-SemiBold', fontWeight: '600' }, drawerIcon: ({ focused, size }) => (
          <Feather name="git-pull-request" size={size} color={focused ? '#2482e3' : '#898989'} />
        ),
      }
      }
      />
      ...
      />
      <Drawer.Screen name="Feedback" component={DriverFeedback} options={{
        headerTitle: 'Feedback', headerTitleAlign: 'center', headerTitleStyle: { fontFamily: 'Poppins-SemiBold', fontSize: 22, fontWeight: '600' }, drawerIcon: ({ focused, size }) => (
          <MaterialIcons name="feedback" size={size} color={focused ? '#2482e3' : '#898989'} />
        ),
      }
